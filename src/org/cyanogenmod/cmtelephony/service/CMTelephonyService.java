package org.cyanogenmod.cmtelephony.service;
/*
...
public class CMTelephonyService extends Service {

    private static final String TAG = "CMTelephonyService";
    ...
    private final Handler mHandler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            if (localLOGD) Log.d(TAG, "handleMessage() called with: " + "msg = [" + msg + "]");
            return true;
        }
    });
    ...
    private final IBinder mBinder = new ICMTelephonyManager.Stub() {
        ...
        public boolean isSubActive(int subId) {
            return CMTelephonyService.this.isSubActive(subId);
        }
        ...
        public void setSubState(int subId, boolean state) {
            CMTelephonyService.this.setSubState(subId, state);
        }
        ...
        public boolean isDataConnectionSelectedOnSub(int subId) {
            return CMTelephonyService.this.isDataConnectionSelectedOnSub(subId);
        }
        ...
        public boolean isDataConnectionEnabled() {
            return CMTelephonyService.this.isDataConnectionEnabled();
        }
        ...
        public void setDataConnectionState(boolean state) {
            CMTelephonyService.this.setDataConnectionState(state);
        }
        ...
        public void setDataConnectionSelectedOnSub(int subId) {
            CMTelephonyService.this.setDataConnectionSelectedOnSub(subId);
        }
        ...
        public void setDefaultPhoneSub(int subId) {
            CMTelephonyService.this.setDefaultPhoneSub(subId);
        }
        ...
        public void setDefaultSmsSub(int subId) {
            CMTelephonyService.this.setDefaultSmsSub(subId);
        }
    };
